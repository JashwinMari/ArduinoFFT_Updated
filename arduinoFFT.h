...
public:
	...
	void Compute(double *vReal, double *vImag, uint32_t samples, uint8_t power, uint8_t dir);
	void DCRemoval(double *vData, uint32_t samples);
	double MajorPeak(double *vD, uint32_t samples, double samplingFrequency);
	void MajorPeak(double *vD, uint32_t samples, double samplingFrequency, double *f, double *v);
	void Windowing(double *vData, uint32_t samples, uint8_t windowType, uint8_t dir);
